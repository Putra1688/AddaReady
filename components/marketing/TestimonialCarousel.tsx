...
const TESTIMONIALS = [
  {
    id: 1,
    name: "Muhammad Azharulloh",
    role: "Mahasiswa Pendidikan Geografi, UM",
    content: "Layanan yang luar biasa! Profil saya sekarang terlihat jauh lebih profesional dan modern. AddaReady sangat responsif dan mengerti detail estetika yang saya cari.",
    rating: 5,
  },
  {
    id: 2,
    name: "Muhammad Arul Sholehuddin, S.Pd.",
    role: "S1 Tadris Matematika, UINMA",
    content: "Sangat puas dengan hasilnya. Performa website sangat cepat dan desainnya benar-benar eksklusif. Ini adalah investasi terbaik untuk branding digital portofolio saya.",
    rating: 5,
  },
  {
    id: 3,
    name: "Ahmad Nabil Ali, S.I.Kom",
    role: "S1 Ilmu Komunikasi, UB",
    content: "AddaReady berhasil mengubah portofolio saya menjadi realitas digital yang memukau. Proses kerjanya transparan dan hasilnya melebihi ekspektasi. Sangat direkomendasikan!",
    rating: 5,
  },
  {
    id: 4,
    name: "Anita Mayasari",
    role: "Jebeng Banyuwangi 2024",
    content: "Detail yang diberikan pada setiap section sangat luar biasa. Website saya menjadi wajah utama branding yang membanggakan. Terima kasih AddaReady!",
    rating: 5,
  },
];
